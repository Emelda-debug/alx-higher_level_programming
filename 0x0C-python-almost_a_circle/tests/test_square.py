#!/usr/bin/python3
# test_square.py
"""Unnittests for models/square.py.
...
class TestSquare_size(unittest.TestCase):
    """Unittests for size initialization of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for initialization of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for initialization of Square y attribute."""
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def capture_stdout(s, method):
        ...
        Args:
            s: The Square printed to stdout.
            method: The method to run on s.
        Returns:
            The text printed to stdout by calling method on s.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
