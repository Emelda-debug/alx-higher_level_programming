...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests for instantiation of the Rectangle class."""
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for initialization of Rectangle width"""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for initialization of Rectangle height"""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for initialization of Rectangle x"""
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect: The Rectangle to print to stdout.
            method (str): The method to run on rect.
        Returns:
            Printed text to stdout by calling method on s.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
